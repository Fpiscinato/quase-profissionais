...
export const EN: Record<string, string> = {
  ...
  '6. Ranking': '6. Ranking',
  '"Ranking" mostra a classificação do torneio do dia e o ranking geral (todos os torneios já jogados), tanto individual quanto por dupla.':
    '"Ranking" shows today\'s tournament standings and the overall ranking (every tournament ever played), both individual and by pair.',
